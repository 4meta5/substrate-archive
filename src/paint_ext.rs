...
impl<T> PaintExt for AuraCall<T>
where
    T: paint_aura::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
...
impl<T> PaintExt for BabeCall<T>
where
    T: paint_babe::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
...
impl<T> PaintExt for BalancesCall<T>
where
    T: paint_balances::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
        match &self {
...
impl<T> PaintExt for ElectionsPhragmenCall<T>
where
    T: paint_elections_phragmen::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
        match &self {
...
impl<T> PaintExt for SessionCall<T>
where
    T: paint_session::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
        match &self {
...
impl<T> PaintExt for TimestampCall<T>
where
    T: paint_timestamp::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
        match &self {
...
impl<T> PaintExt for FinalityCall<T>
where
    T: paint_finality_tracker::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
        match &self {
...
impl<T> PaintExt for ImOnlineCall<T>
where
    T: paint_im_online::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
        match &self {
...
impl<T> PaintExt for NicksCall<T>
where
    T: paint_nicks::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
...
impl<T> PaintExt for StakingCall<T>
where
    T: paint_staking::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
        match &self {
...
impl<T> PaintExt for SystemCall<T>
where
    T: paint_system::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
        match &self {
...
impl<T> PaintExt for GrandpaCall<T>
where
    T: paint_grandpa::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
        match &self {
...
impl<T> PaintExt for SudoCall<T>
where
    T: paint_sudo::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
...
impl<T> PaintExt for TreasuryCall<T>
where
    T: paint_treasury::Trait,
{
    fn function(&self) -> PaintResult<FunctionInfo> {
        match &self {
